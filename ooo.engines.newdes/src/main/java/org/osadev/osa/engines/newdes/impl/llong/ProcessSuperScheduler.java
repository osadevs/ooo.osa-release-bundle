...
import org.osadev.osa.engines.newdes.impl.AbstractProcessSuperScheduler;
...
public class ProcessSuperScheduler extends AbstractProcessSuperScheduler<Long> 
implements SuperSchedulerControlItf,ProcessSuperSchedulerItf<Long> {
	
	public ProcessSuperScheduler() {
		super(new SimulationLogger<Long>(ProcessSuperScheduler.class), ModelingTime.getFactory());
	}
